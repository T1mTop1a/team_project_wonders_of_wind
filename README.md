...
```
cd existing_repo
git remote add origin https://stgit.dcs.gla.ac.uk/team-project-h/2022/sh06/sh06-main.git
git branch -M main
...
- [ ] [Set up project integrations](https://stgit.dcs.gla.ac.uk/team-project-h/2022/sh06/sh06-main/-/settings/integrations)
